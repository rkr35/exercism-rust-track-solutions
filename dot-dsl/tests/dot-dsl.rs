...
fn test_graph_with_one_node() {
    let nodes = vec![Node::new("a".to_string())];
    ...
    assert_eq!(graph.nodes, vec![Node::new("a".to_string())]);
}

#[test]

fn test_graph_with_one_node_with_keywords() {
    let nodes = vec![Node::new("a".to_string()).with_attrs(&[("color", "green")])];
    ...
    assert_eq!(
        graph.nodes,
        vec![Node::new("a".to_string()).with_attrs(&[("color", "green")])]
    );
}
...
fn test_graph_with_one_edge() {
    ...
    assert_eq!(
        graph.edges,
        vec![Edge::new("a".to_string(), "b".to_string())]
    );
}
...
fn test_graph_with_attributes() {
    let nodes = vec![
        Node::new("a".to_string()).with_attrs(&[("color", "green")]),
        Node::new("c".to_string()),
        Node::new("b".to_string()).with_attrs(&[("label", "Beta!")]),
    ];

    let edges = vec![
        Edge::new("b".to_string(), "c".to_string()),
        Edge::new("a".to_string(), "b".to_string()).with_attrs(&[("color", "blue")]),
    ];
